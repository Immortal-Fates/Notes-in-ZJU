...
- $K_n$ Toeplitz matrix   invertible  fixed-fixed
  ...
  ![image-20241223212506166](assets/01-工程数学方法Ⅰ.assets/image-20241223212506166.png)
...
- $C_n$ Circulant matrix  not invertible  ——循环，periodic problem
  ...
  ![image-20241223213144338](assets/01-工程数学方法Ⅰ.assets/image-20241223213144338.png)

- $T_n$ changing $K_n$ to $T_n$  free-fixed

  The (1, 1) entry in Tn is changed from 2 to 1:

  ![image-20241223214430819](assets/01-工程数学方法Ⅰ.assets/image-20241223214430819.png)
...
- $B_n$ Changing $T_n$ to $B_n$  not invertible  free-free
  ...
  ![image-20241223220544915](assets/01-工程数学方法Ⅰ.assets/image-20241223220544915.png)
...
>
> ![image-20241225171513428](assets/01-工程数学方法Ⅰ.assets/image-20241225171513428.png)
>
...
$$
![image-20241225185650821](assets/01-工程数学方法Ⅰ.assets/image-20241225185650821.png)
...
![image-20241225190353465](assets/01-工程数学方法Ⅰ.assets/image-20241225190353465.png)
...
![image-20241225192149428](assets/01-工程数学方法Ⅰ.assets/image-20241225192149428.png)

- $A=LU=LDL^T$,D is symmetric

  ![image-20241225192617520](assets/01-工程数学方法Ⅰ.assets/image-20241225192617520.png)
  $$
  U=DL^T
  $$
...
![image-20241225193754751](assets/01-工程数学方法Ⅰ.assets/image-20241225193754751.png)

![image-20241225203032616](assets/01-工程数学方法Ⅰ.assets/image-20241225203032616.png)
...
![image-20241225211034732](assets/01-工程数学方法Ⅰ.assets/image-20241225211034732.png)
...
![image-20241226001247293](assets/01-工程数学方法Ⅰ.assets/image-20241226001247293.png)
...
- solve by finite differences
  ...
  ![image-20241226150514309](assets/01-工程数学方法Ⅰ.assets/image-20241226150514309.png)

  - Forward Euler

  - Backward Euler

    ![image-20241226151036896](assets/01-工程数学方法Ⅰ.assets/image-20241226151036896.png)

    ![image-20241226153317588](assets/01-工程数学方法Ⅰ.assets/image-20241226153317588.png)

  - trapezoidal method梯形法

    ![image-20241226151431878](assets/01-工程数学方法Ⅰ.assets/image-20241226151431878.png)
...
$$
![image-20241226154535383](assets/01-工程数学方法Ⅰ.assets/image-20241226154535383.png)
$$
\min_u ||Au-b||_2^2
$$
...
![image-20241226162229596](assets/01-工程数学方法Ⅰ.assets/image-20241226162229596.png)

![image-20241226160448682](assets/01-工程数学方法Ⅰ.assets/image-20241226160448682.png)

![image-20241226175315363](assets/01-工程数学方法Ⅰ.assets/image-20241226175315363.png)
...
![image-20241226165518378](assets/01-工程数学方法Ⅰ.assets/image-20241226165518378.png)

![image-20241226165457686](assets/01-工程数学方法Ⅰ.assets/image-20241226165457686.png)
...
![image-20241226211529450](assets/01-工程数学方法Ⅰ.assets/image-20241226211529450.png)

=$U^T KU$

对于两边相等的函数，左右同时乘上一个测试函数积分仍然相等；反过来就得for any v(x)左右相等才能得到两个函数相等

![image-20241226212020807](assets/01-工程数学方法Ⅰ.assets/image-20241226212020807.png)
...
![image-20241226230412381](assets/01-工程数学方法Ⅰ.assets/image-20241226230412381.png)
...
1. Optimization and Minimum Principles:
