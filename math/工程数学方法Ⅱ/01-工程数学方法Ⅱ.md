...
- trapezoidal梯形(Crank-Nickolson):second-order method implicit
  ...
  ![image-20241223194144363](assets/01-工程数学方法Ⅱ.assets/image-20241223194144363.png)
...
- **backwards differences** ODE15S:second-order method
  ...
  ![image-20241223222350723](assets/01-工程数学方法Ⅱ.assets/image-20241223222350723.png)

- DAE(differential algebraic equation)

  ![image-20241223224414331](assets/01-工程数学方法Ⅱ.assets/image-20241223224414331.png)
...
- solution for every $u(x,0)=e^{ikx}$
  ...
  ![image-20241223230607740](assets/01-工程数学方法Ⅱ.assets/image-20241223230607740.png)

- Finite Difference Methods for  $u_t=cu_x$

  ![image-20241223231749079](assets/01-工程数学方法Ⅱ.assets/image-20241223231749079.png)

  - Accuracy of the Upwind Difference Equation

    ![image-20241223232241303](assets/01-工程数学方法Ⅱ.assets/image-20241223232241303.png)
    $$
  ...
  - Lax-Wendroff
    ...
    ![image-20241223234826405](assets/01-工程数学方法Ⅱ.assets/image-20241223234826405.png)

  - Lax-Friedrichs

- Equivalence of Stability and Convergence

  ![image-20241223235615706](assets/01-工程数学方法Ⅱ.assets/image-20241223235615706.png)

  ![image-20241223235705360](assets/01-工程数学方法Ⅱ.assets/image-20241223235705360.png)

  ![image-20241223235841942](assets/01-工程数学方法Ⅱ.assets/image-20241223235841942.png)
