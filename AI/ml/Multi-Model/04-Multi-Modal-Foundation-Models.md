...
- __Visual Instruction Tuning.__ *Haotian Liu et al.* __ArXiv, 2023__ [(Arxiv)](https://arxiv.org/abs/2304.08485) [(S2)](https://www.semanticscholar.org/paper/a5036f31f0e629dc661f120b8c3b1f374d479ab8) (Citations __8151__) -- LLaVA: **L**arge **L**anguage **a**nd **V**ision **A**ssistant

  - Takeaway: 

    LLaVA connects a pretrained vision encoder with a large language model (LLM) and trains the combined system using **visual instruction tuning**, enabling the model to reason about images through natural language.
