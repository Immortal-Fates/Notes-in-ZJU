...
我们先来介绍Diffusion Model中的经典模型DDPM(Denoising Diffusion Probabilistic Models)

![image-20250425163409480](assets/10-1-diffusion.assets/image-20250425163409480.png)

> The sculpture is already complete within the marble block before I start my work. It is already there, I just have to chisel away the superfluous material——Michelangelo

来看看Diffusion Model到底是怎么实现的

![image-20250425192824751](assets/10-1-diffusion.assets/image-20250425192824751.png)
...
- Forward Diffusion Process
  ...
  ![image-20250425194008111](assets/10-1-diffusion.assets/image-20250425194008111.png)
  ...
  ![image-20250425194613712](assets/10-1-diffusion.assets/image-20250425194613712.png)
  ...
  \end{equation}
  $$
  ![image-20250425164208186](assets/10-1-diffusion.assets/image-20250425164208186.png)
...
- Reverse Diffusion Process
  ...
  >
  > ![image-20250425212538404](assets/10-1-diffusion.assets/image-20250425212538404.png)
  ...
  $$
  ![image-20250425212552436](assets/10-1-diffusion.assets/image-20250425212552436.png)
...
- illustration of training
  ...
  1. Randomly select a time step and encode it.
     ...
     ![image-20250425213320178](assets/10-1-diffusion.assets/image-20250425213320178.png)

  2. Add noise to image

     ![image-20250425213932716](assets/10-1-diffusion.assets/image-20250425213932716.png)

  3. Train the UNet

     ![image-20250425213940953](assets/10-1-diffusion.assets/image-20250425213940953.png)

     将Gaussian noise和推理出的Predicted noise进行$L_{L2}$损失反向传播

- illustration of sampling

  1. Iteratively denoise the image (T = 1000)![image-20250425214541943](assets/10-1-diffusion.assets/image-20250425214541943.png)
  ...
  3. Iteratively denoise the image (T = 1)
     ...
     ![image-20250425214619701](assets/10-1-diffusion.assets/image-20250425214619701.png)
...
- U-Net: consists of a downsampling stack and an upsampling stack
  ...
  ![image-20250426212255677](assets/10-1-diffusion.assets/image-20250426212255677.png)
...
- Diffusion Transformer
  ...
  ![image-20250426213043281](assets/10-1-diffusion.assets/image-20250426213043281.png)
