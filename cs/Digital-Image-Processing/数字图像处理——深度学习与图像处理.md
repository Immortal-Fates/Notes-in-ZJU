...
![image-20250610150016973](assets/数字图像处理——深度学习与图像处理.assets/image-20250610150016973.png)

## 图像检索

- 定义：图像检索就是通常意义上的**以图搜图**，给定一张图像，从图库中找出跟它匹配的图像，并按相似度进行排序，越相似的越靠前

  ![image-20250610150106147](assets/数字图像处理——深度学习与图像处理.assets/image-20250610150106147.png)

- 基本流程

  ![image-20250610150125146](assets/数字图像处理——深度学习与图像处理.assets/image-20250610150125146.png)
...
3. 图像检索：根据图片特征之间的距离进行排序，返回检索结果
   ...
   ![image-20250610150412270](assets/数字图像处理——深度学习与图像处理.assets/image-20250610150412270.png)
...
- 经典算法
  ...
  - Faster R-CNN
    ...
    ![image-20250610160908577](assets/数字图像处理——深度学习与图像处理.assets/image-20250610160908577.png)
  ...
  ![image-20250610161437862](assets/数字图像处理——深度学习与图像处理.assets/image-20250610161437862.png)
...
- 模型发展历程
  ...
  1. 开山之作：FCN: 《Fully Convolutional Networks for Semantic Segmentation》CVPR2015 可以说近年来的所有分割模型都是以FCN结构为基本模型，有以下两个关键点
     ...
     ![image-20250610164558085](assets/数字图像处理——深度学习与图像处理.assets/image-20250610164558085.png)
  ...
  4. Deeplab系列： V1、V2、V3、V3+
     ...
     ![image-20250610164902629](assets/数字图像处理——深度学习与图像处理.assets/image-20250610164902629.png)
