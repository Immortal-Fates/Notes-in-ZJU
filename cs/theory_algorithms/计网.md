...
![image-20240227082014461](assets/计网.assets/image-20240227082014461.png)
...
![image-20240228110530857](assets/计网.assets/image-20240228110530857.png)
...
![image-20240227092243287](assets/计网.assets/image-20240227092243287.png)
...
![image-20240227214122235](assets/计网.assets/image-20240227214122235.png)
...
- 物理媒体
  ...
  - 非导引型媒体unguided media：开放的空间传输电磁波或者光信号
    ...
    ![image-20240227231539719](assets/计网.assets/image-20240227231539719.png)
...
![image-20240228095603131](assets/计网.assets/image-20240228095603131.png)
...
![image-20240228100200182](assets/计网.assets/image-20240228100200182.png)
...
![image-20240228100356578](assets/计网.assets/image-20240228100356578.png)
...
![image-20240228110433363](assets/计网.assets/image-20240227092243287.png)

## Service Models

TCP/IP 5层模型

![image-20240228111248662](assets/计网.assets/image-20240228111248662.png)

ISO/OSI：表示层，会话层

![img](assets/计网.assets/v2-1dd6e1ed2f348db47ce0cde38d545ae9_b.webp)
...
![image-20240228111530139](assets/计网.assets/image-20240228111530139.png)
...
![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714056589627-3.png)

reponse status codes

![image-20240307090206019](assets/计网.assets/image-20240307090206019.png)
...
- Web caches——proxy
  ...
  ![image-20240312081641867](assets/计网.assets/image-20240312081641867.png)
  ...
  ![image-20240313163912910](assets/计网.assets/image-20240313163912910.png)

  ![image-20240312083315585](assets/计网.assets/image-20240312083315585.png)
...
![img](assets/计网.assets/1014269-20170409223018066-559106935.png)
...
![image-20240402155619364](assets/计网.assets/image-20240402155619364.png)
...
![image-20240313183611830](assets/计网.assets/image-20240313183611830.png)
...
- SMTP：simple mail transfer protocol
  ...
  - ![image-20240312085840538](assets/计网.assets/image-20240312085840538.png)

![image-20240312090717585](assets/计网.assets/image-20240312090717585.png)
...
![image-20240314081313054](assets/计网.assets/image-20240314081313054.png)
...
![image-20240314082314168](assets/计网.assets/image-20240314082314168.png)

- recursive query(递归询问)

![image-20240314082417473](assets/计网.assets/image-20240314082417473.png)
...
- DNS records
  ...
  ![image-20240314083320809](assets/计网.assets/image-20240314083320809.png)

- DNS protocol messages

  ![image-20240314083638080](assets/计网.assets/image-20240314083638080.png)

![image-20240314084421541](assets/计网.assets/image-20240314084421541.png)
...
![image-20240314090148194](assets/计网.assets/image-20240314090148194.png)

P2P

![image-20240314090202991](assets/计网.assets/image-20240314090202991.png)
...
![image-20240314091518743](assets/计网.assets/image-20240314091518743.png)
...
![image-20240319084953299](assets/计网.assets/image-20240319084953299.png)

![image-20240319084946156](assets/计网.assets/image-20240319084946156.png)
...
- host uses **IP addresses** & **port numbers** to direct segment to appropriate socket
  ...
  ![image-20240324191445246](assets/计网.assets/image-20240324191445246.png)
...
![image-20240307081642467](assets/计网.assets/image-20240307081642467.png)

![image-20240308114335079](assets/计网.assets/image-20240308114335079.png)
...
- UDP(User Datagram Protocol  )
  ...
  ![UDP segment header](assets/计网.assets/image-20240324192244100.png)
...
- TCP(Transmission Control Protocol  )
  ...
  - flow control:发送方发送数据的范围，需要考虑到接收方缓冲区的情况——滑动窗口（rcvbuffer）
    ...
    ![img](assets/计网.assets/v2-9747d74ee520a55134d9a334ff2acbf4_720w.webp)
  ...
  - connection-oriented  ：三次握手与四次挥手
    ...
    ![img](assets/计网.assets/v2-8ff1a615e0d4eb7158d6023240b806a8_720w.webp)
    ...
    ![img](assets/计网.assets/v2-d2caf785480897d7af3c325d4260620c_720w.webp)
    ...
    *如果此时机器A马上关闭连接，会导致数据不完整、机器B无法释放连接等问题。所以此时机器A需要等待2个报文生存最大时长，确保网络中没有任何遗留报文了，再关闭连接*
    ...
    1. 最后，机器A等待两个报文存活最大时长之后，机器B 接收到ACK报文之后，均关闭连接，进入CLASED状态
  ...
  - TCP congestion control: AIMD  ——approach: senders can increase sending rate until packet loss(congestion) occurs, then decrease sending rate on loss event
    ...
    ![img](assets/计网.assets/v2-4c0280a3487b0155d89d2b8d7071cbbe_720w.webp)
...
![img](assets/计网.assets/v2-d10406026f779867bd79a0c4404c64e2_720w.webp)

![image-20240326111435401](assets/计网.assets/image-20240326111435401.png)

> TCP首部固定长度是20字节，下面还有4字节是可选的
>
> socket不是还需要IP进行定位吗？IP地址在网络层被附加了

![img](assets/计网.assets/v2-7628f69d209c39dad689a7bb7c022d5d_720w.webp)

![img](assets/计网.assets/v2-8281ccf689726b52613266af8a085981_720w.webp)

选项字段中包含以下其他选项：

![img](assets/计网.assets/v2-ebbc1733018bac538bf16ed612254982_720w.webp)
...
![img](assets/计网.assets/v2-6f186dadeb1540023ae3ef429c1b90a7_720w.webp)
...
![img](assets/计网.assets/v2-3e26e7f49722d319a4f67595c91b64cf_720w.webp)
...
![image-20240402081312218](assets/计网.assets/image-20240402081312218.png)

# Network layer——data plane

![在这里插入图片描述](assets/计网.assets/20200628100232914.png)

[网络层（The Network Layer)](https://blog.csdn.net/Rong_Toa/article/details/80639635)

![image-20240409231621448](assets/计网.assets/image-20240409231621448.png)
...
![image-20240402083607880](assets/计网.assets/image-20240402083607880.png)

## Router

![image-20240402090335000](assets/计网.assets/image-20240402090335000.png)
...
- switching fabrics
  ...
  - ![image-20240402092014943](assets/计网.assets/image-20240402092014943.png)

    - memory：direct control of CPU;copied to memory

      ![image-20240402092340986](assets/计网.assets/image-20240402092340986.png)
...
![img](assets/计网.assets/53207dfc77d94001888368086347b547.png)
...
- IP分包与组包(Fragmentation & Reassembly)
  ...
  **重组**：只在最终的目标主机进行
  ...
  ![eg](assets/计网.assets/image-20240409232010999.png)
...
![image-20240409232241361](assets/计网.assets/image-20240409232241361.png)
...
![image-20240409233333001](assets/计网.assets/image-20240409233333001.png)
...
![image-20240409234705049](assets/计网.assets/image-20240409234705049.png)
...
![img](assets/计网.assets/6eb6a3a25e3a4db89a2f2119b326c08c.png)
...
![img](assets/计网.assets/d03f6d72d9b742ea890f7e30d7ccaf4f.png)
...
![image-20240409233817291](assets/计网.assets/image-20240409233817291.png)
...
![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70.png)
...
![img](assets/计网.assets/ac41ab297eaf476d85afad830fb6780d.png)
...
![img](assets/计网.assets/06daaff233284270b02e4d92e92c07d9.png)
...
![img](assets/计网.assets/86e9e64bc9f7419eb7961a69a0cb89bb.png)
...
![image-20240415163713738](assets/计网.assets/image-20240415163713738.png)

### link state

LS 路由——知道全局拓扑

![image-20240415172006169](assets/计网.assets/image-20240415172006169.png)
...
![image-20240415170949976](assets/计网.assets/image-20240415170949976.png)

![image-20240415171349175](assets/计网.assets/image-20240415171349175.png)
...
![image-20240416080718023](assets/计网.assets/image-20240416080718023.png)
...
- 链路失效和恢复：
  ...
  ![image-20240416081404196](assets/计网.assets/image-20240416081404196.png)

- 进程处理

  ![image-20240416081556873](assets/计网.assets/image-20240416081556873.png)
...
![image-20240416081828821](assets/计网.assets/image-20240416081828821.png)

- 层次化的OSPF路由

  ![image-20240416081933026](assets/计网.assets/image-20240416081933026.png)

  ![image-20240416081947365](assets/计网.assets/image-20240416081947365.png)
...
![image-20240416083659569](assets/计网.assets/image-20240416083659569.png)
...
- 路径通告
  ...
  ![BGP](assets/计网.assets/image-20240416085646615.png)

- BGP报文

  使用TCP交换报文

  ![image-20240416085728271](assets/计网.assets/image-20240416085728271.png)

- 路径选择
  - 热土豆路由——只关心内部区域的最小代价，不操心域间的代价
  - ![image-20240416090039975](assets/计网.assets/image-20240416090039975.png)
...
![image-20240416091129607](assets/计网.assets/image-20240416091129607.png)

### OpenFlow

- openflow协议

  ![image-20240416091211983](assets/计网.assets/image-20240416091211983.png)
...
![image-20240416091609639](assets/计网.assets/image-20240416091609639.png)

![image-20240416091703513](assets/计网.assets/image-20240416091703513.png)
...
- **循环冗余检测CRC**[2.1.5 校验码（一文带你分析搞懂：奇偶校验码、海明码、CRC码）_校验码比较](https://blog.csdn.net/weixin_43914604/article/details/104183321)
  ...
  - ![循环冗余校验](assets/计网.assets/2020112719194016.png)
...
![image-20240416153033667](assets/计网.assets/image-20240416153033667.png)
...
![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714068534067-177.png)
...
- 当需要发送数据报到子网以外的节点时
  ...
  ![A-R-B链路层数据](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3lvbmdoZW5nMTEyMw==,size_16,color_FFFFFF,t_70#pic_center.png)
...
![img](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714056923283-165.png)

奈氏准则：$理想低通道下的极限数据传输率=2W\log_2 V(b/s),W是信道带宽$

![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714057134028-168.png)

香农定理

![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714057382668-171.png)

![在这里插入图片描述](assets/计网.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzkxNDYwNA==,size_16,color_FFFFFF,t_70-1714057509358-174.png)
