...
2. 用 consts, enums 和 inlines 取代 #defines
   ...
   ![image-20240626215137739](assets/effective-c-plus-plus.assets/image-20240626215137739.png)
   ...
   - 一个是const 一个是non-const ，但是内容除了能否被修改差不多
     ...
     ![image-20240626215817037](assets/effective-c-plus-plus.assets/image-20240626215817037.png)
...
4. 构造、析构、赋值运算
   ...
   ![image-20240626221246653](assets/effective-c-plus-plus.assets/image-20240626221246653.png)

   如果不想使用，则放在private里面，为了防止成员函数和友元函数调用，只提供声明，不提供定义

   ![image-20240626222928316](assets/effective-c-plus-plus.assets/image-20240626222928316.png)
