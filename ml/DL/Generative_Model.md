...
- **Generative Adversarial Networks**. Ian J. Goodfellow et.al. **arxiv**, **2014**, ([pdf](..\..\..\papers\models\Generative_Adversarial_Networks.pdf))([link](http://arxiv.org/abs/1406.2661v1)).
...
```
set PYTHONUTF8=1
autoliter -i ./Generative_Model.md -o ../../../papers/models/
```
