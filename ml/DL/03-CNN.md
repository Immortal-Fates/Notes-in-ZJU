...
> 以图像为例
>
> [直观可视化](https://github.com/vdumoulin/conv_arithmetic/blob/master/README.md)
...
- Cons: There is a difference between mean and var in training and testing. This difference becomes more obvious as the batch size decreases. For smaller batch sizes, the BN will cause big error.

  Solution: Avoid the batch dimension:
