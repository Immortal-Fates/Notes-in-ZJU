...
- **Scale variation**: multiple anchor sizes detect multi-scale objects
- **Aspect ratio variation**
- **Training stability**: early detectors needed predefined priors
- **Dense predictions**: systematizes regression targets on feature grids
...
- [stanford intro](https://cs231n.stanford.edu/slides/2024/lecture_9.pdf?utm_source=chatgpt.com)
...
- [introduce to object detection](https://www.geeksforgeeks.org/computer-vision/what-is-object-detection-in-computer-vision/)
