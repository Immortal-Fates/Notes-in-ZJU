...
- SRAM usage = input activation + output activation
...
- **TinyNAS** (neural architecture search for MCUs)
- **TinyEngine** (inference engine optimized for SRAM-constrained execution)
